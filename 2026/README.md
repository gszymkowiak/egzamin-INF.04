...
Zadanie polega na wykonaniu aplikacji konsolowej (klasa Kosc, która reprezentuje pojedynczą kostkę do gry) oraz aplikacji mobilnej zgodnie z wymaganiami podanymi w arkuszu egzaminacyjnym.
